...
import RowOfPics from "./RowofPics"
    ...
    <div className=''>
      ...
      <Image src={me} width={width} height={height} alt='Arthurs dog' className='rounded-full bg-zinc-800 object-cover h-16 w-16 my-4' />
        ...
        <div className="mt-6 flex gap-6">
          <a class="group -m-1 p-1" aria-label="Follow on X" href="https://twitter.com/Stuepp3">
          ...
          <a class="group -m-1 p-1" aria-label="Follow on Instagram" href="https://www.instagram.com/arthurh.cavalcanti/">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
          ...
          <a class="group -m-1 p-1" aria-label="Follow on GitHub" href="https://github.com/Stuepp">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
          ...
          <a class="group -m-1 p-1" aria-label="Follow on LinkedIn" href="https://www.linkedin.com/in/arthur-cavalcanti-9928ba152/">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">

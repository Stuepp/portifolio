...
export default function About(){
  ...
  let img ='/downloadedImage.png'

  return(
      <div className='sm:px-8 mt-16 sm:mt-32'>
        <div className='mx-auto w-full max-w-7xl lg:px-8'>
          <div className='mt-16 mx-auto sm:mt-32 lg:px-12'>
            <div className='grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12'>

              <div className='lg:pl-20'>
                <div className='max-w-xs px-2.5 lg:max-w-none'>
                  <Image src={img} width={412} height={412} alt='' className='aspect-square rotate-3 rounded-2xl bg-zinc-100 object-cover dark:bg-zinc-800' />
                  <p>ps: how AI sees me</p>
                </div>
              </div>

              <div className='lg:order-first lg:row-span-2'>
                <h1 className='text-4xl font-bold tracking-tigh sm:text-5xl text-zinc-100'>I'm Arthur Henrique Cavalcanti. I live in Florianópolis but also in Joinville
                  fot the university.
                </h1>
              ...
              <div className='lg:pl-20'>
                <ul role='list'>
                  <li className='flex'>
                    <a class="group flex text-sm font-medium text-zinc-200 transition hover:text-teal-500" href="#">
                  ...
                  <li class="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
                    <a class="group flex text-sm font-medium text-zinc-200 transition hover:text-teal-500  " href="mailto:arthurh.cavalcanit@hotmail.com">
                      <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500">
                      ...
                      <span class="ml-4">arthurh.cavalcanit@hotmail.com</span>
                    </a>
                  </li>
                </ul>
              </div>
